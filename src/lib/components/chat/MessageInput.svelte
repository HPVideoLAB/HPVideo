<script lang="ts">
  ...
  import ImgToVideo from './MessageInput-modules/ImgToVideo.svelte';
...
<div class="fixed bottom-0 {$showSidebar ? 'left-0 md:left-[310px]' : 'left-0'} right-0">
  <div class="w-full">
    ...
    <div class="bg-white dark:bg-gray-900">
      {#if currentModel.length > 0 && allowModel.includes(currentModel[0])}
        <ImgToVideo />
      {:else}
        <div class="px-5 md:px-20 mx-auto inset-x-0 bg-red-500">
          <div class="pb-[30px]">
            <input
