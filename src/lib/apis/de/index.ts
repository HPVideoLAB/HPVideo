  ...
  const format_res = {
    models: [
      ...
      //             #1 on WaveSpeed leaderboard (T2V Elo 1333, I2V 1392).
      {
        ...
        textmodel: 'happyhorse-1.1/text-to-video',
        imagemodel: 'happyhorse-1.1/image-to-video',
        audio: true,
        duration: [5, 8],
        amount: { '720': [0.77, 1.232], '1080': [1.0395, 1.6632] },
      ...
      },
      {
        ...
        source: 'alibaba',
        model: 'wan-2.7',
        textmodel: 'wan-3.0/text-to-video',
        imagemodel: 'wan-3.0/image-to-video',
        audio: true,
        duration: [5, 10],
        amount: { '480': [0.275, 0.55], '720': [0.55, 1.10], '1080': [1.10, 2.20] },
      ...
      },
      {
        ...
        source: 'minimax',
        model: 'hailuo-2.3',
        textmodel: 'h3/text-to-video',
        imagemodel: 'h3/image-to-video',
        audio: false,
        duration: [6, 10],
        amount: { '*': [0.66, 1.10] },
        size: ['1366*768'],
      ...
      },
      {
        ...
        source: 'bytedance',
        model: 'seedance-2.0',
        textmodel: 'seedance-2.5/text-to-video',
        imagemodel: 'seedance-2.5/image-to-video',
        audio: true,
        duration: [6, 9, 12],
        amount: { '*': [2.376, 3.564, 4.752] },
      ...
      },
      {
        ...
        source: 'kwaivgi',
        model: 'kling-3.0',
        textmodel: 'kling-video-o3-std/text-to-video',
        imagemodel: 'kling-video-o3-std/image-to-video',
        audio: true,
        duration: [5, 10],
        amount: { '*': [0.462, 0.924] },
        size: ['9:16', '16:9'],
